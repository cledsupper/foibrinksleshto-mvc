...
public class ORIConstantes {
	...
	/* Erros relativos Ã s Exceptions dos ORIs. */
	...
	public static final String STRING_ERRO_ORI_JA_EXISTE = "Um ORI com os mesmos atributos já existe no banco de dados";
	...
	/* Erros diversos. */
	public static final String STRING_ERRO_DAC_NAO_ENCONTRADO = "Número de linhas afetadas = 0.";
}
